...
func InitDBConn(ctx context.Context) (dbpool *pgxpool.Pool, err error) {
	url := "host=185.112.83.36 port=5432 user=postgres password=pwrd_octa dbname=postgre sslmode=disable"
...
func InitMockDBConn(ctx context.Context) (dbpool *pgxpool.Pool, err error) {
	url := "host=185.112.83.36 port=5432 user=postgres password=pwrd_octa dbname=postgre_test sslmode=disable"
